...
You can run the [chatbot.ipynb](https://github.com/piyushpathak03/Simple-Chatbot-using-NLTK/blob/master/Chatbot.ipynb) which also includes step by step instructions.
* Through Terminal
```
python chatbot.py
```
